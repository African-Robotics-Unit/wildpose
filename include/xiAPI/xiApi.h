...
#define  XI_PRM_CONCAT_IMG_MODE                            "concat_img_mode"                        // Enable/disable the ConcatenatedImages feature 
#define  XI_PRM_CONCAT_IMG_COUNT                           "concat_img_count"                       // Number of images concatenated in one payload 
#define  XI_PRM_CONCAT_IMG_TRANSPORT_IMG_OFFSET            "concat_img_transport_img_offset"        // Offset between headers and images in bytes on transport 
...
#define  XI_PRM_DUAL_ADC_GAIN_RATIO                        "dual_adc_gain_ratio"                    // Sets DualADC Gain Ratio 
...
typedef enum
{
	...
	XI_SENSOR_FEATURE_BLACK_LEVEL_OFFSET_RAW=6, // Sensor specific register raw black level offset
	XI_SENSOR_FEATURE_SHORT_INTERVAL_SHUTTER=7, // Short Interval Shutter - sensor specific feature
